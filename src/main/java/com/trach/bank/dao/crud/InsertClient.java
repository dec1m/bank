...
public class InsertClient extends SqlUpdate {
    ...
    private static final String sql = "INSERT INTO clients (first_name,last_name,password,phone_number,birth_day) VALUES" +
            "(:first_name,:last_name,:password,:phone_number,:birth_day)";
